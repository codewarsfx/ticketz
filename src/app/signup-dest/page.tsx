    ...
    <>
      ...
      <div className=" h-screen  flex items-center justify-center ">
        ...
        <div className="p-12 mx-8 w-full lg:w-auto flex flex-col items-center justify-center border border-black rounded-2xl shadow-md">
          <h1 className="my-5 text-2xl font-bold text-center  text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-600">
